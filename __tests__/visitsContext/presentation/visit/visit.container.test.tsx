...
describe('VisitsContainer', () => {
  ...
  it('should show list of visits without remarque', () => {
    const { queryByTestId } = render(<VisitsContainer {...props({ visits: [new Visit(1, '12', 'f', 'd', [], undefined)] })} />);
  ...
  it('should show list of visits without remarque', () => {
    ...
    const visitArray: Visit[] = [
      new Visit(1, '12', 'f', 'd', [{ md: [flashPhoto], ds: '', dt: '', lvl: 1, tk: '', nt: false }], undefined),
      new Visit(2, '2', 'x', 'y', [{ md: [flashPhoto], ds: '', dt: '', lvl: 1, tk: '', nt: true }], undefined),
    ]


    const { getAllByTestId } = render(<VisitsContainer
      {...props(
        {
          visits: visitArray
        })}
