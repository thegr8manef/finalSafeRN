...
export class ApiStatisticService implements StatisticService {
  private headers: Record<string, string> = {
    'Content-Type': 'application/json',
  };
  loadStatistic(_params): Observable<Stat> {
    ...
    return new ObservableAjaxHttpClient()
      ...
      .pipe(
        map(response => StatMapper.mapRemoteStatsToStat(response.response)),
