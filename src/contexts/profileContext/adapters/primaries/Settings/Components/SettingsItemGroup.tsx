import { View, StyleSheet, SafeAreaView, Text, SectionList, TouchableOpacity } from 'react-native';
  ...
  const DATA = [
    {
      ...
      data:[
        ...
        },
        {
          ...
          name:DateNow,
            icon: 'https://png.pngtree.com/png-vector/20191121/ourmid/pngtree-blue-bird-vector-or-color-illustration-png-image_2013004.jpg',
          }
    ]
    },
    {
...
{item.name ===null ?   (<View style={{flex:0.5}}></View>) : (
                          <View style={{ flex: 0.5,flexDirection:'column',flexWrap:'wrap'}}>
