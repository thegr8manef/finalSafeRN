...
interface Props {
    ...
    AddNewPointsToImproveModal: () => void;
}

export const PointsToImproveModal = (props: Props) => {
    ...
    return (
        <Modal
            ...
            <View style={styles.container}>
                ...
                />
                <WarringTextView WarringTest={t('txt.add.edit.point.to.improove')} />
                {
                    ...
                    />
                        ...
                        <View style={styles.view_no_strong_point}>
                            <Text style={styles.no_strong_point}  >{t('text.negative.points.empty')}</Text>
                        </View>
                    )
                }
                <Pressable style={styles.footer} onPress={props.AddNewPointsToImproveModal}>
                    <Image source={utils.images.btn_add_circle} style={styles.image_add} />
                    <Text style={styles.text_add}>{t('txt.create.new.point.to.improove')}</Text>
                </Pressable>
            </View>
        </Modal>
    );
