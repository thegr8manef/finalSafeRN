...
import { FlashActionRemoveRemark, FlashActionTypes } from '../../../useCases/saveFlash/actionTypes';
import { SaveFlash, removeFlashRemark } from '../../../useCases/saveFlash/action';
...
const mapStateToProps = (state: AppState): StateToPropsType => ({
  ...
  createdRemark: createdRemarkSelector(state),
});
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchToPropsType => ({
  ...
  removeRemark: (): FlashActionRemoveRemark => dispatch(removeFlashRemark()),
});
